...
@testset "exclude_pull_requests_from_forks" begin
    @testset "normal case" begin
        ...
        result = CompatHelper.exclude_pull_requests_from_forks(origin_repo, [pr_from_origin])
    ...
    @testset "empty case" begin
        @test isempty(CompatHelper.exclude_pull_requests_from_forks(GitHub.Repo(), Vector{GitHub.PullRequest}()))
    end
end
...
@testset "only_my_pull_requests" begin
    ...
    @testset "empty case" begin
        @test isempty(CompatHelper.only_my_pull_requests("foobar", Vector{GitHub.PullRequest}()))
    end
end
