...
Test.@testset "pull_requests.jl" begin
    ...
    Test.@test _repos_are_the_same(a, a)
    Test.@test _repos_are_the_same(a, b)
    Test.@test !_repos_are_the_same(a, c)
    Test.@test _repos_are_the_same(b, a)
    Test.@test _repos_are_the_same(b, b)
    Test.@test !_repos_are_the_same(b, c)
    Test.@test !_repos_are_the_same(c, a)
    Test.@test !_repos_are_the_same(c, b)
    Test.@test _repos_are_the_same(c, c)
end
