const DEFAULT_REGISTRIES = Pkg.RegistrySpec[Pkg.RegistrySpec(name = "General", uuid = "23338594-aafe-5451-b93e-139f81909106", url = "https://github.com/JuliaRegistries/General.git")]
...
function main(
    ...
    for subdir in subdirs
        ...
        make_pr_for_new_version(
            api, clone_hostname, repo, dep_to_current_compat_entry, dep_to_current_compat_entry_verbatim,
            dep_to_latest_version, deps_with_missing_compat_entry, pr_list, pr_titles, ci_cfg;
            auth=auth, env=env, keep_existing_compat=keep_existing_compat, drop_existing_compat=drop_existing_compat,
            bump_compat_containing_equality_specifier=bump_compat_containing_equality_specifier, master_branch=master_branch,
            subdir=subdir, pr_title_prefix=pr_title_prefix, registries=registries
        )
    end
