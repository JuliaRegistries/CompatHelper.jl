function get_project_deps(
    api::GitHub.GitHubAPI, clone_hostname::HostnameForClones, repo::GitHub.Repo;
    auth::GitHub.Authorization, master_branch::Union{DefaultBranch, AbstractString}, subdir::AbstractString
)
    ...
    return dep_to_current_compat_entry, dep_to_current_compat_entry_verbatim, dep_to_latest_version, deps_with_missing_compat_entry
end
